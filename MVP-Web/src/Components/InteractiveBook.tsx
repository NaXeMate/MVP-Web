...
const PageIndicator: React.FC<PageIndicatorProps> = ({
  ...
  return (
    <span
      ...
      onClick={startEdit}
    >
      {currentPage} / {numPages > 0 ? numPages - 1 : 0}
    </span>
  );
};
          ...
          <div className="book-center">
            {numPages > 0 && (
              <div
                ...
                style={{ width: pageSize.w * 2, maxWidth: "100%" }}
              >
                <span className="book-header-title">
                  MVP II - La Llamada del Aura
                </span>
                <span className="book-header-chapter">
            ...
            <Document
              ...
              error={
                <div className="error-message">Error al cargar el PDF.</div>
              }
            >
              {numPages > 0 && (
                <HTMLFlipBook
            ...
            {numPages > 0 && (
              <div
                className="book-footer-controls"
                style={{ width: pageSize.w * 2, maxWidth: "100%" }}
              >
                <BackButton
                  onClick={prevFlip}
                  className="book-nav-button-large"
                  size={72}
                />
